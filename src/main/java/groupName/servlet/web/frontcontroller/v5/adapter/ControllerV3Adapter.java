package groupName.servlet.web.frontcontroller.v5.adapter;

import groupName.servlet.web.frontcontroller.ModelView;
import groupName.servlet.web.frontcontroller.v3.ControllerV3;
import groupName.servlet.web.frontcontroller.v5.MyHandlerAdapter;
...
public class ControllerV3Adapter implements MyHandlerAdapter {
    ...
    public ModelView handle(HttpServletRequest request, HttpServletResponse response, Object handler) throws ServletException, IOException {
        ControllerV3 controller = (ControllerV3) handler; //Object -> ControllerV3 형변환
